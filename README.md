...
| [`content/00-系统架构设计师考试大纲-清洗版`](content/00-系统架构设计师考试大纲-清洗版/) | 前言 + 文件材料 + 考试说明 + 3 个考试科目 + 独立题型举例 + 1 个索引 | 大纲首轮清洗稿 |
...
| [`sources/00-系统架构设计师考试大纲`](sources/00-系统架构设计师考试大纲/) | 来源说明 | 69 页扫描件（无文本层），源 PDF 已入库 |

| [`sources/01-系统架构设计师教材`](sources/01-系统架构设计师教材/) | 来源说明 | 2022 年第 2 版、720 页扫描件（含 OCR 文本层），源 PDF 已入库 |
...
sources/                             # 来源层：第三方原始材料与其书目事实
  ...
  00-系统架构设计师考试大纲/         # 源扫描件（已入库）与说明

  01-系统架构设计师教材/             # 源扫描件（已入库）与说明
