...
| [`01.系统架构设计师教材-清洗版`](01.系统架构设计师教材-清洗版/) | 前言 + 20 章 + 1 个索引 | 20 章均已对照用户本地 721 页教程复核缺图，能可靠判定的图表已结构化恢复；仍非逐字权威校对 |
| [`02.历年真题`](02.历年真题/) | 33 份试题文件 | 本地原始材料；质量、题量和答案来源不一 |
| [`02.历年真题(补充)`](02.历年真题%28补充%29/) | 20 份试题文件 | 补充来源；与原始材料存在同名但内容不同的文件 |
| [`02.历年真题-清洗版`](02.历年真题-清洗版/) | 37 份试题正文 + 1 个索引 | 36 份标准名 canonical 已完成结构清洗与重点缺图审计，另有 1 份独立备选；不代表官方校对完成 |

当前 36 份唯一试卷均有标准名首选清洗稿（36/36）；清洗目录另保留 2023 年下半年综合知识回忆版 A（65 题），因此共有 37 份试题正文。两个来源目录的 53 份原始版/补充版正文均已映射为备选，其中 17 组同名文件存在内容冲突，禁止自动混并。2023 年下半年综合知识以回忆版 B75 为首选，A65 仅用于交叉复核；2019 年及 2024 年下半年综合知识已整理到 75 题；2021 年下半年案例的 5 题结构与 FACE 图已恢复；2025 年下半年案例已整理为 5 题，但试题五问题 3 仍只有裁切图片段。2024 年上下半年案例和 2024 年下半年综合知识等少数试卷仍保留经证据审计确认的来源冲突或不可裁决项。这里的“结构清洗与重点缺图审计”不表示题面、图表、答案或解析已经官方或权威校对。
...
- 已确认缺失的教材图表在可复核范围内转换为 Mermaid、Markdown 表格或文字关系表，并记录来源页码和校验信息；这些是结构化重绘，不是原始版式复制。
