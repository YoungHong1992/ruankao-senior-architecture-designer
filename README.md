...
以下统计以各资料对应的索引与审计账本统计日期为准（真题/教材：2026-07-12；大纲：2026-09-01）。“已提取”或“已清洗”只表示已有对应 Markdown，不代表逐页、逐题完成权威校对。

| 目录 | 当前内容 | 状态 |
|---|---:|---|
| [`00.系统架构设计师考试大纲`](00.系统架构设计师考试大纲/) | 5 篇正文 + 1 个索引 | OCR/原始整理稿已纳入 |
| [`00.系统架构设计师考试大纲-清洗版`](00.系统架构设计师考试大纲-清洗版/) | 前言 + 5 篇正文 + 1 个索引 | 前言及第01—05章已完成两轮逐页视觉核对并修订；账本记录 48 项 findings（含页码治理与时效性注） |
