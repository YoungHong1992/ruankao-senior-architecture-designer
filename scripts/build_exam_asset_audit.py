...
SOURCE_LIMITED_VISUAL_ITEMS = [
    {
        ...
        "limitation": (
            "近时点回忆图与后期培训 PDF 在生命线名称、请求处理节点和消息编号分配上冲突；"
            "培训答案只能作为非官方候选，仍无官方逐空答案。"
        ),
    ...
    },
    {
        ...
        "limitation": "完整原卷框图、空号数量和位置未取得。",
        "current_handling": "仅提供有技术资料支持的协议分配教学示意。",
    },
    {
        "id": "2024-h1-case-q4-ap-flow",
        "path": PATH_2024_H1_CASE,
        "location": "试题四自动驾驶 AP 流程图",
        "limitation": "完整原卷流程图、箭头、端口和空号未取得。",
        "current_handling": "仅转录二手材料可共同支持的规划控制关系。",
    },
    {
        "id": "2024-h2-case-q1-quality-table",
        "path": PATH_2024_H2_CASE,
        "location": "试题一质量属性分类表",
        "limitation": "后期完整结构版与较早回忆版的预填单元格、空号位置冲突，缺官方原卷裁决。",
        "current_handling": "两套完整位置版本并列隔离，分别标注来源与时间，不拼成单一卷面。",
    },
    {
        "id": "2024-h2-case-q3-nginx-slot",
        "path": PATH_2024_H2_CASE,
        "location": "试题三 Web 架构 Nginx 空位",
        "limitation": "前端顶部位置及后端预填 Nginx 可确认，但公开版本将前端空号分别记为（3）和（8）。",
        "current_handling": "恢复共同几何结构，并将（3）/（8）两套编号作为冲突版本隔离。",
    },
    {
        "id": "2025-h2-case-q5-3-petri",
        "path": "02.历年真题-清洗版/2025年下半年-系统架构设计师-案例分析.md",
        "location": "试题五问题 3",
        "limitation": "仅有裁切图 2 片段，缺完整 Petri 网、具体指令和可靠答案。",
        "current_handling": "完整恢复问题 2 的货物接运网及表格，问题 3 保留明确未恢复状态。",
    },
]
