...
本目录放置考试大纲的**源 PDF**。该文件已按 2026-09 治理决定随仓库入库；
...
- 本文件已归档到维护者私有仓库
  ...
  的 `00-系统架构设计师考试大纲.pdf`，固定提交号见
  [DATA_SOURCES.md](../../DATA_SOURCES.md) 的「源 PDF 私有归档清单」。

## 使用方式

克隆仓库后即可用该 PDF 做人工比对；文件由 `.gitignore` 的 `!` 反选放行，
对应关系登记在 [catalog/corpora.json](../../catalog/corpora.json) 的 `outline.source`。
